 ...
 * @see       \App\Controllers\HomeController::about()
 * 
 * Description:
 * Renders the project overview and architecture presentation view. Outlines the 3-tier MVC 
...
<section class="about-panel rounded-4 p-4 p-md-5">
    ...
    <ul>
        <li><strong>Presentation Tier:</strong> HTML5, Bootstrap, views and client-side JavaScript validation.</li>
        <li><strong>Application / Business Tier:</strong> Controllers, custom regex Router, request handling and server-side validation.</li>
        <li><strong>Data Tier:</strong> Models, PDO database connection and handwritten SQL queries.</li>
    </ul>

    <!-- Core Application Capabilities List -->
